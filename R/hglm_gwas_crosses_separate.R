...
gwas_pen_bovans_load <- run_gwas(pen_bovans_load$data$X6,
                                 model.matrix(~ 1 + weight + breed, pen_bovans_load_covar),
...
gwas_pen_lsl_load <- run_gwas(pen_lsl_load$data$X6,
                              model.matrix(~ 1 + weight + breed, pen_lsl_load_covar),
...
gwas_cage_bovans_load <- run_gwas(cage_bovans_load$data$X6,
                          model.matrix(~ 1 + weight + breed, cage_bovans_load_covar),
...
gwas_cage_lsl_load <- run_gwas(cage_lsl_load$data$X6,
                               model.matrix(~ 1 + weight + breed, cage_lsl_load_covar),
                               Z_grm_cage_lsl_load,
...
gwas_all_bovans_load <- run_gwas(all_bovans_load$data$X6,
                                 model.matrix(~ 1 + weight + breed + cage.pen, all_bovans_load_covar),
...
gwas_all_lsl_load <- run_gwas(all_lsl_load$data$X6,
                              model.matrix(~ 1 + weight + breed + cage.pen, all_lsl_load_covar),
...
gwas_pen_bovans_weight <- run_gwas(pen_bovans_weight$data$X6,
                                 model.matrix(~ 1 + weight + breed, pen_bovans_weight_covar),
...
gwas_pen_lsl_weight <- run_gwas(pen_lsl_weight$data$X6,
                              model.matrix(~ 1 + weight + breed, pen_lsl_weight_covar),
...
gwas_cage_bovans_weight <- run_gwas(cage_bovans_weight$data$X6,
                                  model.matrix(~ 1 + weight + breed, cage_bovans_weight_covar),
...
gwas_cage_lsl_weight <- run_gwas(cage_lsl_weight$data$X6,
                               model.matrix(~ 1 + weight + breed, cage_lsl_weight_covar),
...
gwas_all_bovans_weight <- run_gwas(all_bovans_weight$data$X6,
                                 model.matrix(~ 1 + weight + breed + cage.pen, all_bovans_weight_covar),
...
gwas_all_lsl_weight <- run_gwas(all_lsl_weight$data$X6,
                              model.matrix(~ 1 + weight + breed + cage.pen, all_lsl_weight_covar),
